export const cards = [
  {
    title: "zoterowin和Android软件下载",
    details: "需要安装体验beta版本和zotero安卓版的朋友可以下载，安卓版会不定期开放体验槽",
  ...
  {
    title: "zotero-style",
    details: "zotero的样式美化插件，包括自动期刊标签，笔记预览，注释自定义，阅读时间等",
    image: "https://pic-go-42.oss-cn-guangzhou.aliyuncs.com/img/202410172200842.png",
  ...
  {
    title: "zotero-addons",
    details: "zotero的插件管理，其实zotero7正式版之后就不怎么需要了",
  ...
  },
  {
    ...
    details: "必装插件，多语言翻译插件，支持谷歌翻译，百度翻译，deepl，谷歌翻译等",
  ...
  },
  {
    ...
    details: "改进zotero的引用功能，实现拖拽引用和快捷键引用，写论文需要",
  ...
  {
    title: "zotero-format-metadata",
    details: "可以规范zotero元数据插件，如日期作者，语言等，必装",
